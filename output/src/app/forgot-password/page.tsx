        ...
        return (
            <div className="w-full max-w-md z-10 text-center">
                ...
                >
                    ...
                    <h1 className="text-3xl font-black tracking-tighter text-white uppercase italic mb-4">Check Your Email</h1>
                    ...
                    {demoLink && (
                        <div className="p-4 bg-primary/10 rounded-2xl mb-8 border border-primary/20">
                            <p className="text-xs font-bold text-primary uppercase tracking-widest mb-2">Demo Mode:</p>
                            <Link
                                href={demoLink}
                                className="text-white hover:text-primary underline text-sm font-medium transition-colors break-all"
                            >
                    ...
                    <button
                        ...
                        className="w-full bg-white text-black font-black py-4 rounded-2xl hover:bg-primary hover:text-white transition-all"
                    >
                        RETURN TO SIGN IN
                    </button>
                </motion.div>
        ...
        <div className="w-full max-w-md z-10">
            <div className="text-center mb-12">
                ...
                <h1 className="text-4xl font-black tracking-tighter text-white uppercase italic">
                    Trouble <span className="text-primary">Signing In?</span>
                </h1>
            ...
            >
                ...
                <div className="mt-10 pt-8 border-t border-white/5 text-center">
                    <Link
                        href="/login"
                        className="text-white/30 hover:text-white text-xs font-bold uppercase tracking-widest transition-colors flex items-center justify-center gap-2"
                    >
